...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-q2z$9m3=o61l90eo&*4jne!nihuj-srh2piaxd+2xf3n*(l!y!')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'mindlift_db'),
        'USER': os.getenv('DB_USER', 'mindlift_user'),
